...
sys.path.append('../../')
from YOLOv6.yolov6.models.effidehead import Detect
...
from YOLOv6.yolov6.utils.checkpoint import load_checkpoint, load_state_dict
from YOLOv6.yolov6.utils.config import Config
from YOLOv6.tools.partial_quantization.eval import EvalerWrapper
from YOLOv6.tools.partial_quantization.utils import get_module, concat_quant_amax_fuse
from YOLOv6.tools.qat.qat_utils import qat_init_model_manu
...
if __name__ == '__main__':
    ...
    print(qat_mAP)
    if args.end2end:
        from YOLOv6.yolov6.models.end2end import End2End
