...
from YOLOv6.yolov6.models.losses.loss import ComputeLoss as ComputeLoss
from YOLOv6.yolov6.models.losses.loss_distill import ComputeLoss as ComputeLoss_distill
from YOLOv6.yolov6.models.losses.loss_distill_ns import ComputeLoss as ComputeLoss_distill_ns
from YOLOv6.yolov6.models.losses.loss_fuseab import ComputeLoss as ComputeLoss_ab
...
from YOLOv6.yolov6.utils.general import download_ckpt
...
class Trainer:
    def __init__(self, args, cfg, device):
        ...
        # fub_loss is Front Upper Border of 3D bounding box loss
        if self.args.pred_fub:
            self.loss_num += 1
            self.loss_info += ['fub_loss']
    ...
    def train_before_loop(self):
        ...
        self.compute_loss = ComputeLoss(num_classes=self.data_dict['nc'],
                                        ...
                                        predict_fub=self.args.pred_fub)
    ...
    def calibrate(self, cfg):
        ...
        if self.main_process:
            from YOLOv6.tools.qat.qat_utils import ptq_calibrate
    ...
    def quant_setup(self, model, cfg, device):
        if self.args.quant:
            from YOLOv6.tools.qat.qat_utils import qat_init_model_manu, skip_sensitive_layers
