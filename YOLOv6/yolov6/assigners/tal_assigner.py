...
from YOLOv6.yolov6.assigners.assigner_utils import select_candidates_in_gts, select_highest_overlaps, iou_calculator
...
class TaskAlignedAssigner(nn.Module):
    ...
    def forward(self,
        ...
        target_labels_lst, target_bboxes_lst, target_fub_list, target_scores_lst, fg_mask_lst = [], [], [], [], []
        ...
        for i in range(cycle):
            ...
            target_labels, target_bboxes, target_fub, target_scores = self.get_targets(
                gt_labels_, gt_bboxes_, gt_fub_, target_gt_idx, fg_mask)
            ...
            target_fub_list.append(target_fub)
        ...
        target_fub = torch.cat(target_fub_list, 0)
        target_scores = torch.cat(target_scores_lst, 0)
        fg_mask = torch.cat(fg_mask_lst, 0)

        return target_labels, target_bboxes, target_fub, target_scores, fg_mask.bool()
    ...
    def get_targets(self,
        ...
        target_fub = gt_fub.reshape([-1, 1])[target_gt_idx]
