...
class ComputeLoss:
    ...
    def __call__(
        ...
        feats, pred_scores, pred_distri, pred_lrtb, pred_fub = outputs
        t_feats, t_pred_scores, t_pred_distri, t_pred_fub = t_outputs[0], t_outputs[-3], t_outputs[-2], t_outputs[-1]
